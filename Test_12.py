...
lastname = "Piddubna"
time.sleep(1)
email = "yuliapiddubna@ukr.net"
time.sleep(1)
password = "leanworldTT16"
time.sleep(1)
reenterpassword = "leanworldTT16"
WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, "//button[contains(text(), 'Register')]"))).click()
